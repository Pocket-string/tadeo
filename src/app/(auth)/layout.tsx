        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          <div className="mb-8">
            ...
            <h1 className="text-display-md text-white mb-4">
              Trading algoritmico sin emociones
            </h1>
            <p className="text-lg text-white/70 leading-relaxed">
              Backtesting cientifico, senales automatizadas y ejecucion desapasionada basada en reglas empiricas.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-white/80">
              ...
              <span>Indicadores tecnicos: EMA, MACD, RSI, Bollinger</span>
            </div>
            <div className="flex items-center gap-3 text-white/80">
              <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span>Backtesting con validacion Out-of-Sample</span>
            </div>
            <div className="flex items-center gap-3 text-white/80">
              <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span>Ejecucion automatizada con gestion de riesgo</span>
            </div>
          </div>
        </div>
